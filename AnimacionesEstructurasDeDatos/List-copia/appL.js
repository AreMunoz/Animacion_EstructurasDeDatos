...
botonAPos.addEventListener("click", event =>{
    ...
    cCodigoUpdate("Posicion("+valor+","+posicion+");");
});
...
botonEInicio.addEventListener("click", event =>{
    eliminarInicio();
    cCodigoUpdate("EliminarInicio( );");
});
//Listo
botonEFinal.addEventListener("click", event =>{
    eliminarFinal();
    cCodigoUpdate("EliminarFinal();");
});
//Listo
botonEPos.addEventListener("click", event =>{
    ...
    cCodigoUpdate("EliminarPosicion(" +posicion+");");
...
botonEVal.addEventListener("click", event =>{
    ...
    eliminarValor(valor);
    eValor.value = null;
    cCodigoUpdate("EliminarValor("+valor+");");
});
